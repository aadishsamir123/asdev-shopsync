                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        selectedTileColor: Colors.green[800]?.withOpacity(0.1),
                            ...
                            child: InkWell(
                              ...
                              child: ListTile(
                                ...
                                subtitle: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    if (docData.containsKey('deadline') && docData['deadline'] != null)
                                      Padding(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              DateFormat('MMM dd, yyyy - hh:mm a')
                                                  .format((docData['deadline'] as Timestamp).toDate()),
                                              style: TextStyle(
                                                fontSize: 12,
                                                color: Colors.grey[600],
                                              ),
                                    ...
                                    if (docData['addedByName'] != null && !_isReorderingMode)
                                      Padding(
                                        padding: const EdgeInsets.only(top: 4),
                                        child: Text(
